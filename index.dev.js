...
const APP_NAME = "TinodeWeb/" + (_version_js__WEBPACK_IMPORTED_MODULE_1__.PACKAGE_VERSION || "0.17");
const API_KEY = "AQEAAAABAAD_rAp4DJh05a1HAwFT3A6K";
const KNOWN_HOSTS = {
  hosted: "web.tinode.co",
  local: _env__WEBPACK_IMPORTED_MODULE_0__.SERVER_URL
};
...
function detectServerAddress() {
  return _env__WEBPACK_IMPORTED_MODULE_0__.SERVER_URL;
}
